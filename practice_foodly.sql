...
INSERT INTO utilisateur (email, nom, prenom) VALUES ('test@gmail.com','DOE', 'John');
INSERT INTO aliment(nom, marque, calories, sucre, graisses, proteines, bio) VALUES ("haricots vert", "Monoprix", 25, 3, 0, 1.7, FALSE);
...
SELECT COUNT(DISTINCT marque) FROM aliment WHERE marque LIKE "%sans marque%";
SELECT COUNT(DISTINCT nom) AS "Haricot vert" FROM aliment WHERE nom = "haricots verts";
